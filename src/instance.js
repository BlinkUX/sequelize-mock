...
/**
 * Get plain value. If no key is given, return all values
 * Sequelize supports both 'getDataValue' and 'get'. In the docs they
 * say the 'preferred method' is through 'get'
 * Sequelize docs: http://docs.sequelizejs.com/class/lib/model.js~Model.html#instance-method-get
 * @param {String} key Key to get the value for
 * @return {Any}
 */
fakeModelInstance.prototype.get = function (key) {
...
/**
 * Set is used to update values on the instance
 * If set is called with an object, it will loop over the object,
 * and call set recursively for each key, value pair
 * Sequelize docs: http://docs.sequelizejs.com/class/lib/model.js~Model.html#instance-method-set
 * @param {String} key Key yo get the value for
 * @param {Any} value
 */
fakeModelInstance.prototype.set = function (key, value) {
