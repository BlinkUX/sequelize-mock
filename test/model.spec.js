...
InstanceMock.prototype.save = function() {
...
describe("Model", function() {
	describe("__constructor", function() {
		...
		it("should assign instanceMethods functions to Instance prototype", function() {
			...
			mdl.Instance.prototype.should.have
				.property("foo")
				.which.is.exactly(fooFn);
		});
	...
	describe("#build", function() {
		...
		it("should build Instance with Instance.prototype functions", function() {
			...
			inst.should.have
				.property("bar")
				.which.is.exactly(mdl.Instance.prototype.bar);
		});
	});
		...
		it("should pass along where value to Instance creation", function(done) {
			...
			mdl
				...
				.then(function(result) {
					...
					result.rows[0]._args[0].should.have
						.property("foo")
						.which.is.exactly("bar");
					done();
				})
				.catch(done);
		});
